...
*/
    ...
    IEnumerator OnCollisionEnter(Collision other)
    {
            ...
            (gameObject.tag == "arrow" || gameObject.tag == "axe" || gameObject.tag == "bomb"))
        {
            ...
            //manage victim's helath status
            GameController.instance.currentTargetSpawn.players[0].GetComponent<PlayerController>().playerCurrentHealth -= damage;

            //play hit sfx
            GameController.instance.currentTargetSpawn.players[0].GetComponent<PlayerController>().playRandomHitSound();
